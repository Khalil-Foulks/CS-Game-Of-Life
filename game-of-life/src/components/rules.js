...
const Rules = () => {
    return (
        <div className = 'rules'>
            ...
            {/* <div>
                <img src={require('../images/Block.png')} alt='Block'></img>
                <img src={require('../images/blinker.png')} alt='blinker'></img>
                <img src={require('../images/Beehive.png')} alt='Beehive'></img>
                <img src={require('../images/LWSS.png')} alt='Lightweight Spaceship'></img>
            </div> */}
        </div>
    )
}
